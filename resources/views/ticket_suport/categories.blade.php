...
@section('title', 'Bayport | Categories')
...
<div class="">
    ...
    <div class="panel-body">
        <div class="col-lg-3">
        <form method="post" action="{{url('/savecategories')}}" autocomplete="Active" accept-charset="UTF-8" >
            {{ csrf_field() }}
    ...
    <table id="reclatodas" class="table table-striped  table-hover" cellspacing="0" width="100%">
        ...
        @foreach($category as $cil)
            <tr>
             ...
             <td>
             <a class="btn btn btn-success btn-xs" href="{{action('TicketController@thiscategory', $cil->id)}}">
