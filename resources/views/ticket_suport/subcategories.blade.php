...
@section('title', 'Bayport | Sub-Categories')
...
<div class="">
    ...
    <div class="panel-body">
        <div class="col-lg-3">
        <form method="post" action="{{url('/savesubcategories')}}" autocomplete="Active" accept-charset="UTF-8" >
            {{ csrf_field() }}
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="number" name="time" id="time" class="form-control" value="{{old('number')}}" required autofocus>
                    </div>
            </div>  
    ...
    <table id="reclatodas" class="table table-striped  table-hover" cellspacing="0" width="100%">
        ...
        @foreach($subcategory as $cil)
            <tr>
             ...
             <td>{{$cil->file}}</td>
             <td>
             <a class="btn btn btn-success btn-xs" href="{{action('TicketController@thissubcategory', $cil->id)}}">
