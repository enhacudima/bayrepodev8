...
@section('title', 'Bayport | This Categories')
...
<div class="">
    ...
    <div class="panel-heading">
        <h4>This Category Edit -> {{$category->name}}
        </h4>
    </div>

    <div class="panel-body" >
        <div class="col-lg-3" style="margin-left: 35%">
        <form method="post" action="{{url('/updatethiscategory')}}" autocomplete="Active" accept-charset="UTF-8" >
            {{ csrf_field() }}
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="number" name="time" id="time" class="form-control" value="{{$category->time}}" required autofocus>
                    </div>
            </div>  
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="text" name="description" id="description" class="form-control" value="{{$category->description}}" required autofocus>
                    </div>
            </div>       
