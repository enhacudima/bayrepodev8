...
@section('title', 'Bayport | This Team')
...
<div class="">
    ...
    <div class="panel-heading">
        <h4>This Category Edit -> {{$team->name}}
        </h4>
    </div>

    <div class="panel-body" >
        <div class="col-lg-3" style="margin-left: 35%">
        <form method="post" action="{{url('/updatethisteam')}}" autocomplete="Active" accept-charset="UTF-8" >
            {{ csrf_field() }}
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        <label>Name</label>
                        <input type="text" name="name" id="name" class="form-control" value="{{$team->name}}" required autofocus>
                    </div>
            </div>       
            ...
            <div class="row">
                    <div class="from-group col-lg-12">
                        ...
                        <input type="text" name="description" id="description" class="form-control" value="{{$team->description}}" required autofocus>
                    </div>
            </div>       
