              ...
              <!-- Messages: style can be found in dropdown.less-->
                      ...
                      <li class="dropdown notifications-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                          ...
                          <span class="label label-warning">(<span data-count="0" class="notif-count">0</span>)</span>
                        </a>
                        <ul class="dropdown-menu">
                        </ul>
                      </li>
                    ...
                    <ul class="navbar-nav mr-auto">
                      ...
                      <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                          <img src="https://griefline.org.au/wp-content/uploads/2015/02/icon-user-default.png" class="user-image" alt="User Image">
                          <span class="hidden-xs">{{ Auth::user()->name }} {{ Auth::user()->lname }}</span>
                        </a>
                        <ul class="dropdown-menu">
                          <!-- User image -->
                          <li class="user-header">
                            <img src="https://griefline.org.au/wp-content/uploads/2015/02/icon-user-default.png" class="img-circle" alt="User Image">
                          ...
                          <li class="user-body">
                            <div class="row">
                              <div class="col-xs-4 text-center">
                                <a href="changePassword">Alterar Password</a>
                              </div>
                              <div class="col-xs-4 text-center">
                                <a href="updatephone">Configurar Telemovel</a>
                              </div>
                              <div class="col-xs-4 text-center">
                                <a href="#">Seguidores</a>
                              </div>
