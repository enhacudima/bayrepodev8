...
<!--tipo chat-->
    ...
    <table id="reclatodas" class="table table-bordered table-hover" cellspacing="0" width="100%">
        ...
        @foreach($reclamacoes as $product)
            <tr>
                ...
                @if($product->status == 5)
                    <td><span class="emanalise">Novo pagamento pendente</span></td>
                ...
                <td>
                    ...
                    <p class="submit">
                        <button type="submit" class="btnEmidio btn btn-primary" value="{{$product->id}}" id="btn">Editar</button>
    ...
    <div id="myModal" class="modal">
        ...
        <div class="modal-content">
            ...
            <form id="formulario" action="{{ url('/gravaraprovacao') }}" method="post">
            ...
            {{ csrf_field() }}
                ...
                <div class="form-group" style="width: 400px">
                    ...
                    <p class="name">
                        <select  id="novoestado"  name="novoestado" required autofocus>
                            ...
                            <option value="6">Pagamento pendente</option>
                        </select>
                ...
                <div class="form-group" style="width: 600px;">
                    ...
                    <p class="text">
                        <textarea type="text" style="height: 120px"  id="comentarios" name="comentarios" ></textarea>
                    </p>
                </div>
                @if ($errors->any())
