            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category"> Deleted users</p>
                </div>
                <div class="card-body">
                  <div class="table-responsive">
                    <table class="table table-hover" id="example">
                      ...
                      <td>
                       <a href="{{action('ListUserController@edituser', $cli->id)}}" class="btn btn-primary btn-xs"><i class="fa fa-fw fa-pencil"></i></a>
                      </td>
                      <td>
                      <a class="btn  btn-primary btn-xs" href="{{action('ListUserController@activeuser', $cli->id)}}">
