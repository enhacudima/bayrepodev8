                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center" width="100%">
                                                                    ...
                                                                    <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px">MIS portal | Novo Ticket</h1>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                    ...
                                                                    <p style="margin: 20px 0 30px 0;font-size: 13px;text-align: center;">Recentemente foi criado novo ticket com a seguinte descrição: <a style="font-style: italic ;font-size: 15px;">{!!$posts->description!!}</a> lembre-se de ver o ticket por completo, para tal <br/><b>Clique no botão a baixo</b>!</p>
