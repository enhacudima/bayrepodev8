...
<div id="featuredImage" class="column"></div>
                            ...
                            <td bgcolor="#F3F3F3" width="100%" style="background-color:#f3f3f3;padding:12px;border-bottom:1px solid #ececec">
                                ...
                                <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;width:100%!important;font-family:Helvetica,Arial,sans-serif;min-width:100%!important" width="100%">
                                    ...
                                    <tr>
                                        ...
                                        <td align="left" valign="middle" width="50%"><span style="margin:0;color:#4c4c4c;white-space:normal;display:inline-block;text-decoration:none;font-size:12px;line-height:20px"><img src="http://www.sticksa.co.za/wp-content/uploads/2014/01/Bayport-3.jpg" width="120" alt=""  style="margin: 50px auto 0 auto" /> MIS Portal | Bayport</span></td>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center" width="100%">
                                                                    ...
                                                                    <h1 style="padding:0;margin:0;color:#ffffff;font-weight:500;font-size:20px;line-height:24px">MIS portal | Notificação</h1>
                                                        ...
                                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td align="center" width="100%" style="padding: 0 15px;text-align: justify;color: rgb(76, 76, 76);font-size: 12px;line-height: 18px;">
                                                                    ...
                                                                    <h3 style="font-weight: 600; padding: 0px; margin: 0px; font-size: 16px; line-height: 24px; text-align: center;" class="title-color">Assunto: {{$posts->assunto}} </h3>

                                                                    <p style="margin: 20px 0 30px 0;font-size: 13px;text-align: center;">Recentemente a sua equipa foi adicionado para fazer parte da resolução  de um ticket criado com a seguinte descrição: <a style="font-style: italic ;font-size: 15px;">{!!$posts->description!!}</a> lembre-se de ver o ticket por completo, para tal <br/><b>Clique no botão a baixo </b>!</p>
                                                                    ou siga o seguinte link http://10.12.32.20/viewthisticket/{{$posts->id}}

                                                                    <div style="font-weight: 200; text-align: center; margin: 25px;"><a style="padding:0.6em 1em;border-radius:600px;color:#ffffff;font-size:14px;text-decoration:none;font-weight:bold" class="button-color" href="http://10.12.32.20/myticket">Ver Todos Tickets</a></div>
                                        ...
                                        <table border="0" cellspacing="0" cellpadding="0" style="font-weight:200;font-family:Helvetica,Arial,sans-serif" width="100%">
                                            ...
                                            <tr>
                                                ...
                                                <td align="center" valign="middle" width="100%" style="border-top:1px solid #d9d9d9;padding:12px 0px 20px 0px;text-align:center;color:#4c4c4c;font-weight:200;font-size:12px;line-height:18px">Regards,
                                                    ...
                                                    <br><b><a href="https//evidevi.com" title="Power By">Power By Bayport MIS © Copyright</a><b>
